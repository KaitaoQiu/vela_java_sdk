...
- API version: no version
  - Build date: 2023-10-16T03:51:06.388007Z[Etc/UTC]
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'task' jar has been published to maven central.
    mavenLocal()       // Needed if the 'task' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "sdk.kubevela:task:0.0.1"
  }
```

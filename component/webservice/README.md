...
- API version: no version
  - Build date: 2023-10-16T03:51:18.842771Z[Etc/UTC]
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'webservice' jar has been published to maven central.
    mavenLocal()       // Needed if the 'webservice' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "sdk.kubevela:webservice:0.0.1"
  }
```
...
## Documentation for Models
 ...
 - [WebserviceSpec](docs/WebserviceSpec.md)

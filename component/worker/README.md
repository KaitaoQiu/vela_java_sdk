...
- API version: no version
  - Build date: 2023-10-16T03:51:20.792631Z[Etc/UTC]
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'worker' jar has been published to maven central.
    mavenLocal()       // Needed if the 'worker' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "sdk.kubevela:worker:0.0.1"
  }
```

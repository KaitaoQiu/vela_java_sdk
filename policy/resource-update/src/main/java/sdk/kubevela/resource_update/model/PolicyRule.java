...
import sdk.kubevela.resource_update.model.RuleSelector;
import sdk.kubevela.resource_update.model.Strategy;
...
public class PolicyRule {
  ...
  public PolicyRule selector(RuleSelector selector) {
  ...
  **/
  ...
  public RuleSelector getSelector() {
    return selector;
  }


  public void setSelector(RuleSelector selector) {
    this.selector = selector;
  }


  public PolicyRule strategy(Strategy strategy) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.selector, policyRule.selector) &&
        Objects.equals(this.strategy, policyRule.strategy);
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PolicyRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PolicyRule` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      RuleSelector.validateJsonObject(jsonObj.getAsJsonObject("selector"));

...
import sdk.kubevela.init_container.model.ValueFrom;
...
public class Env {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Env env = (Env) o;
    return Objects.equals(this.name, env.name) &&
        Objects.equals(this.value, env.value) &&
        Objects.equals(this.valueFrom, env.valueFrom);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Env
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Env.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Env.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Env` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("valueFrom") != null && !jsonObj.get("valueFrom").isJsonNull()) {
        ValueFrom.validateJsonObject(jsonObj.getAsJsonObject("valueFrom"));
      }
  }

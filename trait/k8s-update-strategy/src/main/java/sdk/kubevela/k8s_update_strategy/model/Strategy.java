...
import sdk.kubevela.k8s_update_strategy.model.RollingStrategy;
...
public class Strategy {
  public static final String SERIALIZED_NAME_ROLLING_STRATEGY = "rollingStrategy";
  @SerializedName(SERIALIZED_NAME_ROLLING_STRATEGY)
  ...
  private TypeEnum type = TypeEnum.ROLLINGUPDATE;

  public Strategy() {
  }

  public Strategy rollingStrategy(RollingStrategy rollingStrategy) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rollingStrategy, strategy.rollingStrategy) &&
        Objects.equals(this.type, strategy.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rollingStrategy, type);
  }
  ...
  public String toString() {
    ...
    sb.append("    rollingStrategy: ").append(toIndentedString(rollingStrategy)).append("\n");
  ...
  static {
    ...
    openapiFields.add("rollingStrategy");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      // validate the optional field `rollingStrategy`
      if (jsonObj.get("rollingStrategy") != null && !jsonObj.get("rollingStrategy").isJsonNull()) {
        RollingStrategy.validateJsonObject(jsonObj.getAsJsonObject("rollingStrategy"));
      }

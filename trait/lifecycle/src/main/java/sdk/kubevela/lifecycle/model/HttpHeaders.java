...
public class HttpHeaders {
  ...
  public HttpHeaders name(String name) {
  ...
  **/
  ...
  public HttpHeaders value(String value) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, httpHeaders.name) &&
        Objects.equals(this.value, httpHeaders.value);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to HttpHeaders
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HttpHeaders.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!HttpHeaders.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HttpHeaders` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HttpHeaders.openapiRequiredFields) {

...
public class DataSource {
  ...
  public DataSource apiGroup(String apiGroup) {
  ...
  **/
  ...
  public DataSource kind(String kind) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiGroup, dataSource.apiGroup) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to DataSource
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DataSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DataSource.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataSource` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

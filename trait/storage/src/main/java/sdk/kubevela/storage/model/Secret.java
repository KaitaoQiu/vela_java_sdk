...
import sdk.kubevela.storage.model.MountToEnv1;
import sdk.kubevela.storage.model.MountToEnvs1;
...
public class Secret {
  ...
  public Secret data(Object data) {
  ...
  **/
  ...
  public Secret mountOnly(Boolean mountOnly) {
  ...
  **/
  ...
  public Secret mountToEnv(MountToEnv1 mountToEnv) {
  ...
  **/
  ...
  public MountToEnv1 getMountToEnv() {
    return mountToEnv;
  }


  public void setMountToEnv(MountToEnv1 mountToEnv) {
    this.mountToEnv = mountToEnv;
  }


  public Secret mountToEnvs(List<MountToEnvs1> mountToEnvs) {
    
    this.mountToEnvs = mountToEnvs;
    return this;
  }

  public Secret addMountToEnvsItem(MountToEnvs1 mountToEnvsItem) {
  ...
  **/
  ...
  public List<MountToEnvs1> getMountToEnvs() {
    return mountToEnvs;
  }


  public void setMountToEnvs(List<MountToEnvs1> mountToEnvs) {
    this.mountToEnvs = mountToEnvs;
  }
  ...
  **/
  ...
  public Secret readOnly(Boolean readOnly) {
  ...
  **/
  ...
  public Secret stringData(Object stringData) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, secret.data) &&
        Objects.equals(this.defaultMode, secret.defaultMode) &&
        Objects.equals(this.items, secret.items) &&
        Objects.equals(this.mountOnly, secret.mountOnly) &&
        Objects.equals(this.mountPath, secret.mountPath) &&
        Objects.equals(this.mountToEnv, secret.mountToEnv) &&
        Objects.equals(this.mountToEnvs, secret.mountToEnvs) &&
        Objects.equals(this.name, secret.name) &&
        Objects.equals(this.readOnly, secret.readOnly) &&
        Objects.equals(this.stringData, secret.stringData) &&
        Objects.equals(this.subPath, secret.subPath);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, defaultMode, items, mountOnly, mountPath, mountToEnv, mountToEnvs, name, readOnly, stringData, subPath);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("mountToEnv") != null && !jsonObj.get("mountToEnv").isJsonNull()) {
        MountToEnv1.validateJsonObject(jsonObj.getAsJsonObject("mountToEnv"));
      }
      if (jsonObj.get("mountToEnvs") != null && !jsonObj.get("mountToEnvs").isJsonNull()) {
        ...
        if (jsonArraymountToEnvs != null) {
          ...
          for (int i = 0; i < jsonArraymountToEnvs.size(); i++) {
            MountToEnvs1.validateJsonObject(jsonArraymountToEnvs.get(i).getAsJsonObject());
          };
        }
      }

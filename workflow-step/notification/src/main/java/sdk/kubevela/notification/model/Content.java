...
public class Content {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.body, content.body) &&
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Content.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Content` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

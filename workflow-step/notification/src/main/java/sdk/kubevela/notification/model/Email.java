...
import sdk.kubevela.notification.model.Content;
import sdk.kubevela.notification.model.From;
...
public class Email {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(content, from, to);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      Content.validateJsonObject(jsonObj.getAsJsonObject("content"));
      // validate the required field `from`
      From.validateJsonObject(jsonObj.getAsJsonObject("from"));

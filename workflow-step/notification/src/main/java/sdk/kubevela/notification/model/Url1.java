...
public class Url1 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Url1.class.getName());
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<Url1>() {
                ...
                public Url1 read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for Url1: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public Url1(UrlOneOf o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public Url1(UrlOneOf1 o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Url1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for Url1 with oneOf schemas: UrlOneOf, UrlOneOf1. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }
